...
from .ip_adapter.ip_adapter import IPAdapterMixin
...
class StableDiffusionXLPipeline(
    ...
    def __init__(
        ...
        self.register_modules(
            ...
            unet=unet,
            controlnet=controlnet if controlnet is not None else None,
            scheduler=scheduler,
        ...
        if controlnet_image is not None:
            ...
            if (
                ...
                # (e.g. [[canny_image_1, pose_image_1], [canny_image_2, pose_image_2]])
                    ...
                    raise ValueError(
                        f"For multiple controlnets: `controlnet_image` must have the same length as the number of controlnets, but got {len(controlnet_image)} images and {len(self.controlnet.nets)} ControlNets."
                    )
    ...
    def __call__(
        ...
        inv_latents_list: Optional[List[torch.FloatTensor]] = None,
        **kwargs,
    ):
        r"""
