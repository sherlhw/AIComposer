...
from diffusers.loaders.lora import LORA_WEIGHT_NAME, LORA_WEIGHT_NAME_SAFE, TEXT_ENCODER_NAME, UNET_NAME
...
class UNet2DConditionLoadersMixin:
    ...
    def _convert_ip_adapter_attn_to_diffusers(self, state_dicts, low_cpu_mem_usage=False):
        from ..sdxl_utils.attention_processor import (
            AttnProcessor,
            AttnProcessor2_0,
        ...
        for name in self.attn_processors.keys():
            ...
            if cross_attention_dim is None or "motion_modules" in name:
                attn_processor_class = (
                    SelfAttnProcessor if hasattr(F, "scaled_dot_product_attention") else AttnProcessor
                )
